...
export default function PageFooter() {
  ...
  return <footer className="projects-page-footer"><div className="projects-page-footer-left"><p className="projects-page-footer-title">ESTUDIO 2 28</p><p>{copy.location}</p><p>(+34) 633 878 755</p></div><div className="projects-page-footer-right"><a className="projects-page-footer-link" href="https://www.instagram.com/estudio_228/" target="_blank" rel="noreferrer">Instagram</a><button type="button" className="projects-page-footer-link">Linkedin</button><button type="button" className="projects-page-footer-link is-muted">{copy.legal}</button><button type="button" className="projects-page-footer-link is-muted">{copy.privacy}</button><button type="button" className="projects-page-footer-link is-muted">{copy.cookies}</button></div></footer>
}
